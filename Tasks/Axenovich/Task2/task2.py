...
hour_db_end = { 1: "час", 2: "два", 3: "три", 4:"четыре", 5: "пять", 6: "шесть", 7: "семь", 8: "восемь", 9: "девять", 10: "десять", 11: "одинадцать", 12: "двенадцать", 0: "двенадцать", 13: 'час'}
...
if minutes == 0:
    if hour == 1:
        ...
        name_hour = 2
    print(user_time, '-', hour_db[hour], names_hours[name_hour], 'ровно')
elif minutes < 20:
    ...
    if minutes_ones == 1:
        ...
        name_minutes = 1
    print(user_time, '- без', minutes_db[minutes], names_minutes[name_minutes], hour_db_end[hour+1])
else:
    if minutes_ones == 0:
