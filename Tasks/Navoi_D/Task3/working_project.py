text = """The February TIOBE Index of the most popular programming languages is out, and while the work going on in the background of TIOBE’s calculations has changed, not much has shifted in the way of rankings.
...
if (len(single_list_words)): 
    ...
    print(" ".join(single_list_words), end = '\n')    
