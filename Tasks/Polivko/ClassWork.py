...
numbers = 'five thirteen two eleven seventeen two one thirteen ten four eight five nineteen'.split()
...
numbers = [numbers_dict[i] for i in numbers]
print(numbers)

# Deleting copies and sorting
