...
def get_generator_of_ranges(list_to_convert : list) -> typing.Generator:
    ...
    for key, value in enumerate(list_to_convert[1:], 1):
        if value == (swap_number+1):
            swap_number = value
        else:
            yield list_to_convert[swaped_from_indxex], list_to_convert[key - 1]
            swaped_from_indxex = key
            swap_number = value
...
if __name__ == '__main__':
    print(check_str('The quick Brown Fox'), ' -> ', '3 upper case, 13 lower case')
