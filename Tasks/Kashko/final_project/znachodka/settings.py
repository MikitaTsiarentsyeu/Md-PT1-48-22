"""
Django settings for znachodka project.
...
SECRET_KEY = 'django-insecure-t%fnk-(i(!=@tif!rkw@pphiq6n!52itnlpvn_qetdpugfgz0d'
...
WSGI_APPLICATION = 'znachodka.wsgi.application'
